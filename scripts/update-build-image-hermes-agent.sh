...
APP_FROM_HARBOR_BASE="${APP_FROM_HARBOR_BASE:-1}"
...
PREINSTALLED_PLAYWRIGHT="${PREINSTALLED_PLAYWRIGHT:-1}"
...
HERMES_PIP_EXTRAS="${HERMES_PIP_EXTRAS:-messaging,cron,cli,web,pty,mcp,feishu}"
